...
y_loc=(50 30 10 0 -20 -40 -60 -200)
file_name=('Hurr10_046.nc' 'Hurr10_048.nc' 'Hurr10_050.nc' 'Hurr10_051.nc' 'Hurr10_053.nc' 'Hurr10_055.nc' 'Hurr10_057.nc' 'Hurr10_071.nc')
NUM_TOT=${#y_loc[@]}

for (( i_loop=0; i_loop<NUM_TOT; i_loop++ )); do
    rm -rf RESTART/*     2>/dev/null || true 
    rm -r 201104.*.nc prog.nc ocean.stats* surffluxes.nc visc.nc Vertical_coordinate.nc ave_prog.nc
  fn="${file_name[i_loop]}"
  (
