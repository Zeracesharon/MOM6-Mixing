...
y_tag=(50 30 10 0 S20 S40 S60 S200)
NUM_TOT=${#y_loc[@]}
...
gcp -r ./LES_noLT_results ./LES_results gfdl:/archive/Qian.Xiao/Qian.Xiao/MOM-examples/${current_folder}/postPro_results/LALI/profile_3/
echo "All done: `date`"
