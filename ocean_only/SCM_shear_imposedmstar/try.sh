...
new_line="#override USE_LA_LI2016 = False"
sed -i "s|^#override USE_LA_LI2016 = .*|$new_line|" MOM_override
new_line="#override MIX_LEN_EXPONENT = 3.0"
sed -i "s|^#override MIX_LEN_EXPONENT = .*|$new_line|" MOM_override
...
gcp -r ./LES_noLT_results/* gfdl:/archive/Qian.Xiao/Qian.Xiao/MOM-examples/${current_folder}/postPro_results/shearon_profile3/
cp -rf ./LES_noLT_results ./profile3
rm -rf LES_noLT_results/*
echo "All done: `date`"

new_line="#override USE_LA_LI2016 = True"
sed -i "s|^#override USE_LA_LI2016 = .*|$new_line|" MOM_override
new_line="#override MIX_LEN_EXPONENT = 3.0"
sed -i "s|^#override MIX_LEN_EXPONENT = .*|$new_line|" MOM_override
...
cp -rf MOM_parameter_doc.all MOM_override MOM_input diag_table ./LES_results/dt_${dt}_DT_${DT}/
cp -rf MOM_parameter_doc.all MOM_override MOM_input diag_table ./LES_noLT_results/dt_${dt}_DT_${DT}/
gcp -r ./LES_noLT_results/* gfdl:/archive/Qian.Xiao/Qian.Xiao/MOM-examples/${current_folder}/postPro_results/shearon_profile3_LT/
cp -rf ./LES_noLT_results ./profile3_LT
rm -rf LES_noLT_results/*
echo "All done: `date`"
